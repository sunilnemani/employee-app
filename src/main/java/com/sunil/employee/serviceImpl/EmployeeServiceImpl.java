...
import com.sunil.employee.feignClient.AddressClient;
...
//					
//					String url = instance.getUri().toString()+instance.getMetadata().get("addressContextPath")+getAddressByEmpNoUrl;
					
//					String url = "http://address-app/address-app/"+getAddressByEmpNoUrl;
					
//					response = this.restTemplate.getForObject(url, BaseResponseDTO.class, empNo);
